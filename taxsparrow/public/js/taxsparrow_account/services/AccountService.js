export async function get_details(type) {
    return taxsparrow.gst_api.call(`account.get_${type}_details`, {
        method: "GET",
...
export async function update_billing_details(new_billing_details) {
    return taxsparrow.gst_api.call("account.update_billing_details", {
        method: "POST",
...
export async function create_order(credits, amount) {
    return taxsparrow.gst_api.call("account.create_order", {
        method: "POST",
        body: { credits, amount },
        with_api_secret: true,
    });
...
export async function verify_payment(orderId) {
    return taxsparrow.gst_api.call("account.verify_payment", {
        method: "POST",
