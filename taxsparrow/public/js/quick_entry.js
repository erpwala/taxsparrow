class GSTQuickEntryForm extends frappe.ui.form.QuickEntryForm {
    constructor(...args) {
        ...
        this.api_enabled = taxsparrow.is_api_enabled() && gst_settings.autofill_party_info;
    }
    ...
    render_dialog() {
        super.render_dialog();
        taxsparrow.set_state_options(this.dialog);
    }
        ...
        return [
            {
                ...
                onchange: () => {
                    ...
                    d.set_value(
                        "gst_category",
                        taxsparrow.guess_gst_category(d.doc._gstin, d.doc.country)
                    );
                },
            },
        ];
            ...
            },
            {
                ...
                onchange: async () => {
                    ...
                    const { message: gstin_list } = await frappe.call(
                        "taxsparrow.gst_india.utils.get_gstin_list",
...
class ItemQuickEntryForm extends frappe.ui.form.QuickEntryForm {
    render_dialog() {
        super.render_dialog();
        taxsparrow.set_hsn_code_query(this.dialog.get_field("gst_hsn_code"));
    }
}
...
function set_gstin_description(gstin_field, status) {
    ...
    gstin_field.set_description(
        taxsparrow.get_gstin_status_desc(status)
    );
}
...
function get_gstin_info(gstin, throw_error = true) {
    return frappe
        .call({
            method: "taxsparrow.gst_india.utils.gstin_info.get_gstin_info",
