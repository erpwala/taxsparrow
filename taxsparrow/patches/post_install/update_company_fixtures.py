...
from taxsparrow.gst_india.overrides.company import (
    make_default_customs_accounts,
    make_default_tax_templates,
)
from taxsparrow.income_tax_india.overrides.company import (
    create_company_fixtures as create_income_tax_fixtures,
)

"""
This patch is used to create company fixtures for Indian Companies created before installing Tax Sparrow.
"""
