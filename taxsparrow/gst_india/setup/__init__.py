...
from taxsparrow.gst_india.constants import GST_UOMS
...
from taxsparrow.gst_india.setup.property_setters import get_property_setters
from taxsparrow.gst_india.utils import get_data_file_path
...
def set_default_accounts_settings():
    """
    Accounts Settings overridden by Tax Sparrow
