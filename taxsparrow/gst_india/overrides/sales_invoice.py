...
from taxsparrow.gst_india.constants import GST_INVOICE_NUMBER_FORMAT
from taxsparrow.gst_india.overrides.payment_entry import get_taxes_summary
from taxsparrow.gst_india.overrides.transaction import (
    _validate_hsn_codes,
    ignore_gst_validations,
    validate_mandatory_fields,
    validate_transaction,
)
from taxsparrow.gst_india.utils import (
    are_goods_supplied,
    get_validated_country_code,
    is_api_enabled,
    is_foreign_doc,
)
from taxsparrow.gst_india.utils.e_invoice import (
    get_e_invoice_info,
    validate_e_invoice_applicability,
)
from taxsparrow.gst_india.utils.e_waybill import get_e_waybill_info
from taxsparrow.gst_india.utils.transaction_data import (
...
def on_submit(doc, method=None):
    ...
    if (
        ...
        frappe.enqueue(
            "taxsparrow.gst_india.utils.e_invoice.generate_e_invoice",
