...
from taxsparrow.gst_india.constants import SALES_DOCTYPES, STATE_NUMBERS
from taxsparrow.gst_india.doctype.gstin.gstin import (
...
from taxsparrow.income_tax_india.overrides.tax_withholding_category import (
