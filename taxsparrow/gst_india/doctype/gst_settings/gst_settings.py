...
from taxsparrow.gst_india.constants import GST_ACCOUNT_FIELDS, GST_PARTY_TYPES
from taxsparrow.gst_india.constants.custom_fields import (
    E_INVOICE_FIELDS,
    E_WAYBILL_FIELDS,
    SALES_REVERSE_CHARGE_FIELDS,
)
from taxsparrow.gst_india.page.taxsparrow_account import (
    _disable_api_promo,
    post_login,
)
from taxsparrow.gst_india.utils import can_enable_api, is_api_enabled
from taxsparrow.gst_india.utils.custom_fields import toggle_custom_fields
from taxsparrow.gst_india.utils.gstin_info import get_gstin_info
...
class GSTSettings(Document):
    ...
    def validate_enable_api(self):
        if (
            ...
            frappe.throw(
                _(
                    "Please counfigure your Tax Sparrow Account to "
                    "enable API features"
                )
            )
