// Copyright (c) 2023, Sparrownova and contributors
...
frappe.ui.form.on("Bill of Entry", {
    ...
    refresh(frm) {
        taxsparrow.set_reconciliation_status(frm, "bill_of_entry_no");
            ...
            frm.add_custom_button(
                ...
                () => {
                    frappe.model.open_mapped_doc({
                        method: "taxsparrow.gst_india.doctype.bill_of_entry.bill_of_entry.make_journal_entry_for_payment",
                        frm: frm,
                    });
                },
                __("Create")
        ...
        if (frm.doc.docstatus === 1 && frm.doc.total_customs_duty > 0) {
            frm.add_custom_button(
                ...
                () => {
                    frappe.model.open_mapped_doc({
                        method: "taxsparrow.gst_india.doctype.bill_of_entry.bill_of_entry.make_landed_cost_voucher",
                        frm: frm,
                    });
                },
                __("Create")
