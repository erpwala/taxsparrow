...
from taxsparrow.gst_india.api_classes.e_invoice import EInvoiceAPI
from taxsparrow.gst_india.api_classes.e_waybill import EWaybillAPI
from taxsparrow.gst_india.constants import STATE_NUMBERS
from taxsparrow.gst_india.constants.e_waybill import (
    ADDRESS_FIELDS,
    CANCEL_REASON_CODES,
    CONSIGNMENT_STATUS,
...
from taxsparrow.gst_india.utils.transaction_data import GSTTransactionData
...
def enqueue_bulk_e_waybill_generation(doctype, docnames):
    ...
    from taxsparrow.gst_india.utils import is_api_enabled
    ...
    rq_job = frappe.enqueue(
        "taxsparrow.gst_india.utils.e_waybill.generate_e_waybills",
        queue="long",
