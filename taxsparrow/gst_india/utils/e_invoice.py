...
from taxsparrow.exceptions import GatewayTimeoutError
from taxsparrow.gst_india.api_classes.e_invoice import EInvoiceAPI
from taxsparrow.gst_india.constants import (
    CURRENCY_CODES,
    EXPORT_TYPES,
    GST_CATEGORIES,
    PORT_CODES,
)
from taxsparrow.gst_india.constants.e_invoice import (
    CANCEL_REASON_CODES,
    ITEM_LIMIT,
)
...
from taxsparrow.gst_india.utils.e_waybill import (
    _cancel_e_waybill,
...
def enqueue_bulk_e_invoice_generation(docnames):
    ...
    rq_job = frappe.enqueue(
        "taxsparrow.gst_india.utils.e_invoice.generate_e_invoices",
