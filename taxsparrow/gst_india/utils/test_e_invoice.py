...
from taxsparrow.gst_india.api_classes.base import BASE_URL
from taxsparrow.gst_india.utils import load_doc
...
from taxsparrow.gst_india.utils.e_waybill import EWaybillData
from taxsparrow.gst_india.utils.tests import append_item, create_sales_invoice
    ...
    def setUpClass(cls):
        ...
        cls.e_invoice_test_data = frappe._dict(
            frappe.get_file_json(
                frappe.get_app_path(
                    "taxsparrow", "gst_india", "data", "test_e_invoice.json"
                )
            )
        )
